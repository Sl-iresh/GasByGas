        ...
        <div class="col-lg-6 col-md-8 col-sm-12">
            <div class="card p-4">
                ...
                <form action="../../controllers/process_request_business.php" method="POST">
                    ...
                    <input type="hidden" name="new_user_id" id="new_user_id"> <!-- Hidden input for user ID -->
				...
				<a target='_blank' href='../../public/Register.php'>	<button   style="background-color: #286ea7; color:#e9ecef;" type="button" class="btn order-btn w-100">Register New user </button> </a> </br>
                    ...
                    <div class="form-group">
                        <label for="user_search">Select Customer</label>
...
<script>
                ...
                .then(data => {
                    ...
                    data.forEach(user => {
                        ...
                        userItem.addEventListener('click', function() {
                            ...
                            // Fetch customer's purchase limit and update quantity input
                            fetchCustomerPurchaseLimit(user.user_id);
                        });
	...
	function fetchCustomerPurchaseLimit(userId) {
    fetch('../../controllers/get_customer_limit.php?user_id=' + userId)
        .then(response => response.json())
        .then(data => {
            ...
            qtyInput.max = data.remaining_limit;
            qtyInput.value = data.remaining_limit; // Reset quantity to 1

            // Disable or enable the submit button based on remaining limit
            if (data.remaining_limit <= 0) {
                submitButton.disabled = true;
                submitButton.textContent = "Limit Reached";
                submitButton.style.backgroundColor = "#dc3545"; // Red color for disabled state
            } else {
                submitButton.disabled = false;
                submitButton.textContent = "Submit Request";
                submitButton.style.backgroundColor = "#28a745"; // Green color for enabled state
            }
        });
}
</script>
